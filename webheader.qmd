...
_Retoweb_ adds additional functionality to control
the header of the website (thus, webheader). Two 
different types are available: `image` or `carousel`.

The [index](index.qmd) page of the template shows
a series of variations for `type: carousel`. The webheader
can be defined in the yml header of the individual `.qmd`.
